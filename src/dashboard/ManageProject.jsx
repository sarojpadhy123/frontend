...
const ManageProject = () => {
  ...
  useEffect(() => {
    fetch("https://keeconstructionback.onrender.com/all-private-projects")
      .then(res => res.json())
  ...
  const handleDelete = (id)=>{
    // console.log(id);
    fetch(`https://keeconstructionback.onrender.com/projects-del-private/${id}`,{
      method: 'DELETE',
          ...
          <Table.Body>
            {allProjects.map((project, index) => (
              <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800" key={project._id}>
                ...
                <Table.Cell>
                  <Link to={`/admin/dashboard/projects-edit-private/${project._id}`} className="font-medium text-cyan-600 hover:underline dark:text-cyan-500 mr-5">
                    Edit
                  </Link>
