...
const UploadGovtProject = () => {
    ...
    const projectCategories = [
      ...
      fetch("https://keeconstructionback.onrender.com/upload-govt-project",{
        method: "POST",
        headers: {
        ...
        return (
          <div className='px-2 my-5'>
            <h2 className='mb-8 text-3xl font-bold'>Upload Government Project</h2>
...
export default UploadGovtProject
